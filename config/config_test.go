...
func TestShouldParse(t *testing.T) {
	...
	assertFeature("DHCPL", c.Features.DHCPL, t)
	assertFeature("Firmware", c.Features.Firmware, t)
	assertFeature("Health", c.Features.Health, t)
	assertFeature("POE", c.Features.POE, t)
	assertFeature("W60G", c.Features.W60G, t)
	...
	assertFeature("Monitor", c.Features.Monitor, t)
	assertFeature("IPAddr", c.Features.IPAddr, t)
	assertFeature("PPP", c.Features.PPP, t)
}
